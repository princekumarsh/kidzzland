...
<div class="container mlr mt-4" style="max-width: -webkit-fill-available;">
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="http://localhost/sync/account-address-update" method="post">
                        <input
                            type="hidden"
                            name="_token"
                            value="zQjqxbow9cxI51b9qpw2sHTh00RRsUhv6tLWPMza"
                        />
                        <div class="row">
                            <div class="col-6">
                                ...
                                <ul class="donate-now">
                                    <li class="address_type_bl">
                                        <input
                                            ...
                                            checked=""
                                        />
                                        <label for="b25" class="component">Shipping</label>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-6 p-2">
                                <div class="form-group">
                                    ...
                                    <input
                                        class="form-control"
                                        value="140, East vishawakarma colony, khemnichak
                                        East vishawakarma colony, khemnichakk"
                                        type="text"
                                        name="address"
                                        id="address"
                                        required=""
