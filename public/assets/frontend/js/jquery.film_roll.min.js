...
! function($) {
    return this.FilmRoll = function() {
        ...
        return t.prototype.configure = function() {
            ...
            var i, e, o, r, n, s;
            for (n = 0, s = this.rotation, e = o = 0, r = s.length; r > o; e = ++o) i = s[e], t > e && e >= 0 && (n += this.childWidth(i));
            return n
        }, t.prototype.marginRight = function(t) {
            var i, e, o, r, n, s, h;
            for (s = this.rotation.length - 1, n = 0, h = this.rotation, e = o = 0, r = h.length; r > o; e = ++o) i = h[e], e > t && s >= e && (n += this.childWidth(i));
            return n
